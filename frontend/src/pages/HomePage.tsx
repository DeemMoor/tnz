    ...
    <main className="page">
      <section className="hero">
        ...
        <p className="hero-sub">
          Любительский турнир по настольному теннису в Ростове-на-Дону от Surf
          Coffee x Atlas и кластера «Новая Земля». Регистрируйся, приходи, следи за
          сеткой и статистикой — с телефона или компьютера.
        </p>
